...
int main(int argc, char** argv)
{
	...
	orientation_sub = nh.subscribe("/haptic_drone/odometry_sensor1/pose", 10, &orientationCallback);
	...
	while(ros::ok())         
	{
		...
		if(!stop)
		{
			...
			logFile.open("/home/emanuele/ethz_ws/haptic_drone_log_file_RPYT.txt", std::ofstream::app);
